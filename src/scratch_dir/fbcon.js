...
app.post('/webhook', (req, res) => {
    ...
    if (body.object === 'page') {
        console.log("-------------- New Event : "+ dateTime.format(now, 'YYYY/MM/DD HH:mm:ss')+" --------------");
...
app.get('/webhook', (req, res) => {
    ...
    let VERIFY_TOKEN = config.fbconnect.VerifyToken;
    ...
    console.log("Challenging with mode : " + mode + " VerifyToken : " + token + " Challenge : "+ challenge);
